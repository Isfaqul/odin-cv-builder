  ...
  return (
    <main className="w-full max-w-4xl mx-auto">
      <hgroup className="flex justify-between items-center print:hidden hide-on-print">
        <h1 className="text-xl text-neutral-200 tracking-wide font-bold my-5 ">Resume Builder</h1>
      </hgroup>

      {/* Resume Starts */}
      <section
        ref={contentRef}
        className="mx-auto min-h-[297mm] bg-slate-100 mt-5 p-5 mb-5 rounded-md shadow-2xl print:shadow-none on-print print:bg-white print:mt-0 print:mb-0 print:p-0"
      >
        <div
          className="absolute top-[267mm] left-0 w-full border-t border-dashed z-10 border-red-500
                  ...
                  before:-translate-x-1/2 before:bg-white before:px-2 before:text-xs before:text-red-600 print:hidden hide-on-print"
        ></div>
      ...
      <button
        className="print:hidden hide-on-print ml-auto block bg-amber-300 text-black cursor-pointer active:bg-amber-400 px-2 py-1 rounded-sm mb-5"
        onClick={print}
      >
        Save PDF
      </button>
