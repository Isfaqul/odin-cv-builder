...
function App() {
  return (
    <main className="w-full max-w-4xl mx-auto relative">
      <h1 className="text-xl text-neutral-200 tracking-wide font-bold my-5 print:hidden print-hidden">
        Resume Builder
      </h1>
      {/* Resume Starts */}
      <section className="mx-auto min-h-[297mm] bg-slate-100 mt-5 p-5 mb-5 rounded-md shadow-2xl">
        <div
